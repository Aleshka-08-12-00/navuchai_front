...
const Profile = observer(() => {
  ...
  // let token = window.localStorage.getItem('tokenHR');
...
TabPanel.propTypes = {
  children: PropTypes.node.isRequired, // Marked as required
  value: PropTypes.number.isRequired, // Marked as required
  index: PropTypes.number.isRequired, // Marked as required
  other: PropTypes.any // Kept as is
};
