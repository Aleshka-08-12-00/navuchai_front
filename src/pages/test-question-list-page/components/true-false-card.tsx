import { Checkbox, IconButton, Radio, Stack, Typography, Menu, MenuItem, Dialog, DialogTitle, DialogContent, DialogActions, Button, Alert, Snackbar } from "@mui/material";
    ...
    return (
        <>
            <div style={{ marginBottom: 20 }}>
                ...
                // onClick={() => navigate(`/main-page/test/${id}/question/1`)} 
                >
                    <>
